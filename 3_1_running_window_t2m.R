...
p1
ggsave("2_generated_plots/3_running_window/fig10a_crps_rolling_window_t2m.png", width = 7, height = 5)
...
ggsave("2_generated_plots/3_running_window/fig11a_t2m_rolling_window_PIT_lead_time_48.png", width = 10, height = 5)
