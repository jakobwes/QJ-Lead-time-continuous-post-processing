...
p1
ggsave("2_generated_plots/3_running_window/fig10b_crps_rolling_window_wind_speed.png", width = 7, height = 5)
...
ggsave("2_generated_plots/3_running_window/fig11b_wind_speed_rolling_window_PIT_lead_time_48.png", width = 10, height = 5)
